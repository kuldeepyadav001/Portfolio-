const SKILLS = [
  {
    category: "Languages",
    items: [
      { name: "C",           icon: "⚙️",  level: "proficient" },
      { name: "Java",        icon: "☕",  level: "proficient" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Flask",       icon: "🔥",  level: "proficient" },
    ]
  },
  {
    category: "Frontend",
    items: [
      { name: "HTML5",       icon: "🌐",  level: "proficient" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "GitHub",      icon: "🐙",  level: "proficient" },
      { name: "API Integration", icon: "🔌", level: "proficient" },
      { name: "JSON",        icon: "📄",  level: "proficient" },
    ]
  },
...
const CERTS = [
  { issuer: "freeCodeCamp",              name: "Responsive Web Design",   date: "September 2025" },
  { issuer: "TATA Foundation",           name: "Data Visualisation",       date: "September 2025" },
  { issuer: "Cisco Networking Academy",  name: "Python Essentials",        date: "September 2025" },
      ...
      <div class="skill-blocks">
        ${cat.items.map(s => `
          <div class="skill-block">
            ...
            <span>${s.name}</span>
            <span class="skill-level ${s.level === 'Developing' ? 'Developing' : ''}">${s.level === 'Developing' ? 'Developing' : 'Proficient'}</span>
          </div>
        `).join('')}
      </div>
    </div>
